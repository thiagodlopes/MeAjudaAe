...
class TeachingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teaching" do
    assert_difference('Teaching.count') do
      post teachings_url, params: { teaching: { content: @teaching.content, name: @teaching.name } }
    end
  ...
  test "should update teaching" do
    patch teaching_url(@teaching), params: { teaching: { content: @teaching.content, name: @teaching.name } }
