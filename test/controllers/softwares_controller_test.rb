...
class SoftwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post softwares_url, params: { software: { category_id: @software.category_id, content: @software.content, name: @software.name, site: @software.site } }
    end
  ...
  test "should update software" do
    patch software_url(@software), params: { software: { category_id: @software.category_id, content: @software.content, name: @software.name, site: @software.site } }
