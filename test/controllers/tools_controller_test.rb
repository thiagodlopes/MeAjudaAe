...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post tools_url, params: { tool: { category_id: @tool.category_id, content: @tool.content, image_url: @tool.image_url, name: @tool.name, site: @tool.site } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { category_id: @tool.category_id, content: @tool.content, image_url: @tool.image_url, name: @tool.name, site: @tool.site } }
